...
function checkAvailability(plugin, methodName, pluginName) {
    ...
    pluginInstance = util_1.getPlugin(pluginRef);
    if (!pluginInstance || (!!methodName && typeof pluginInstance[methodName] === 'undefined')) {
        if (!window.cordova) {
            util_1.cordovaWarn(pluginName, methodName);
            return exports.ERR_CORDOVA_NOT_AVAILABLE;
        }
        util_1.pluginWarn(pluginName, pluginPackage, methodName);
...
function callCordovaPlugin(pluginObj, methodName, args, opts, resolve, reject) {
    ...
    if (availabilityCheck === true) {
        var pluginInstance = util_1.getPlugin(pluginObj.constructor.getPluginRef());
...
function wrapPromise(pluginObj, methodName, args, opts) {
    ...
    var p = util_1.getPromise(function (resolve, reject) {
        if (opts.destruct) {
...
function wrapOtherPromise(pluginObj, methodName, args, opts) {
    if (opts === void 0) { opts = {}; }
    return util_1.getPromise(function (resolve, reject) {
...
function overrideFunction(pluginObj, methodName, args, opts) {
    ...
    return new Observable_1.Observable(function (observer) {
        var availabilityCheck = checkAvailability(pluginObj, methodName);
        if (availabilityCheck === true) {
            var pluginInstance_1 = util_1.getPlugin(pluginObj.constructor.getPluginRef());
