...
__decorate([
    core_2.CordovaInstance({ destruct: true }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
var GoogleMap = (function (_super) {
    ...
    function GoogleMap(element, options) {
        var _this = _super.call(this) || this;
        if (core_2.checkAvailability(GoogleMaps.getPluginRef(), null, GoogleMaps.getPluginName()) === true) {
...
var HtmlInfoWindow = HtmlInfoWindow_1 = (function (_super) {
    ...
    function HtmlInfoWindow() {
        var _this = _super.call(this) || this;
        if (core_2.checkAvailability(HtmlInfoWindow_1.getPluginRef(), null, HtmlInfoWindow_1.getPluginName()) === true) {
...
exports.HtmlInfoWindow = HtmlInfoWindow;
/**
 * @hidden
 */
