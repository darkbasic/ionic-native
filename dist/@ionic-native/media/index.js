...
})(MEDIA_STATUS = exports.MEDIA_STATUS || (exports.MEDIA_STATUS = {}));
var MEDIA_ERROR;
...
var Media = Media_1 = (function (_super) {
    ...
    Media.prototype.create = function (src) {
        var instance;
        if (core_2.checkAvailability(Media_1.getPluginRef(), null, Media_1.getPluginName()) === true) {
